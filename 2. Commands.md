...
3. Check that the reference checksum matches the real checksum
   ...
   ```
   ```html
   <span style="color:blue">Output: "bitcoin-0.16.0-arm-linux-gnueabihf.tar.gz: OK"</span>
   ```
   This is <span style="color: red;">red text</span> and <span style="background-color: yellow;">highlighted text</span>.
