...
* **You want to run Bitcoin over the regular Interbet ***and*** Tor:** Remove all the Tor configurations except for `proxy=127.0.0.1:9050`. This will remove all of the restrictions the other settings make, but still tell Bitcoin Core that you're also running Tor and how to connect over it _as well as_ the regular clearnet way.
